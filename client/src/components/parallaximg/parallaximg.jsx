...
const ParallaxImg = () => {
    return (
        <div className="section__padding hometitle-content" id="home" style={{marginTop :-300,paddingBottom:200}}>
            {/* Big Gekko image */}
            <div style={{marginTop :250,marginLeft: -100,position:'absolute',zIndex: 1, transform:'scale(0.7)'}}> 
            ...
            <div style={{marginTop :300,marginLeft: 400,position:'absolute',zIndex: 1, transform:'scale(0.3)'}}> 
            ...
            <div style={{marginTop :200,marginLeft: 400,position:'absolute',zIndex: 1, transform:'scale(0.6)'}}> 
            ...
            <div style={{marginTop :500,marginLeft: -350,position:'absolute',zIndex: 1, transform:'scale(0.3)'}}> 
