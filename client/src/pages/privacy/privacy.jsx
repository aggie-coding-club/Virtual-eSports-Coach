    ...
    return (
        <div className="vec__privacy">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Virtual eSports Coach, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Virtual eSports Coach, N/A.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Virtual eSports Coach, accessible from <a href="www.vecoach.xyz" rel="external nofollow noopener" target="_blank">www.vecoach.xyz</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: vec@vecoach.xyz</li>
            </ul>
        </div>
    )
}
